...
run_name = datetime.datetime.now().strftime("%Y-%m-%d-%H-%M-%S") + '---细分类--'+'自己的方法'
...
train_images_path = '/data1/liaojunqi/ljq/coding/source_dataset_fine_fenlei/Visual'

train_audio_path = '/data1/liaojunqi/ljq/coding/source_dataset_fine_fenlei/Audio'

train_tactile_path = '/data1/liaojunqi/ljq/coding/source_dataset_fine_fenlei/Haptic'
...
for i in range(opt.n_epochs):
    ...
    if i%10==0:
        ...
        torch.save(best_Encoder_Image_state, f"Encoder_Image_fenlei_fine.pth")
        torch.save(best_Encoder_Audio_state, f"Encoder_Audio_fenlei_fine.pth")
        torch.save(best_Fusion_I_A_state, "Fusion_I_A_fenlei_fine.pth")
        torch.save(best_encoder_fenlei_state, "encoder_haptic_fenlei_fine.pth")
