...
class haptic_encoder_fenlei_fine(nn.Module):

    def __init__(self, input_size1):
        super(haptic_encoder_fenlei_fine, self).__init__()

        self.densenet4 = nn.Linear(input_size1, 256)
        self.relu1 = nn.ReLU()
        self.densenet5 = nn.Linear(256, 108)
...
class haptic_dis_gan_2(nn.Module):
    def __init__(self, input_size):
        super(haptic_dis_gan_2, self).__init__()
